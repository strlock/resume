                        ...
                        <div class="block-inner">
                            ...
                            <div class="block-description">
                                <div class="accordion" id="portfolioAccordion">
                                    @foreach ($portfolioItems as $i => $portfolioItem)
                                        <div class="accordion-item">
                                            <h2 class="accordion-header" id="portfolio{{ $i }}">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse{{ $i }}" aria-expanded="true" aria-controls="collapse{{ $i }}">
                                                    {{ $portfolioItem[1] }}
                                                </button>
                                            </h2>
                                            <div id="collapse{{ $i }}" class="accordion-collapse collapse{{ $i === 0 ? ' show' : '' }}" aria-labelledby="portfolio{{ $i }}" data-bs-parent="#portfolioAccordion">
                                                <div class="accordion-body">
                                                    <div class="portfolio-item">
                                                        <p><img src="{{ asset($portfolioItem[2]) }}" width="300" /></p>
                                                        <p>{{ __('resume.portfolio-description-'.$i) }}</p>
                                                        <a href="{{ $portfolioItem[0] }}" target="blank" class="button-2">{{ __('resume.toWebsite')  }}</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
